...
expName = 'quest_blur'  # from the Builder filename that created this script
expInfo = {
    'participant': '',
}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\京都大学\\Desktop\\zhu\\quest_blur\\quest_blur_lastrun.py',
...
for thisImageType in imageType:
    ...
    for level, condition in staircase:
        ...
        imgTmp = img3.copy()
        sigma = 0.2*(10**level)
        blur = cv2.GaussianBlur(imgTmp,(0,0),sigmaX=sigma,sigmaY=0)
        cv2.imwrite(source+"tmp.png",blur)
