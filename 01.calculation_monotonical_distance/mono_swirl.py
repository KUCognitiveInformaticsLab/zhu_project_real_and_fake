...
def swirlFind(step_size):
    ...
    for mode_num in range(6):
            ...
            pre = "jnd/"
            swirl_jnd_mean = 0.4188819432176951  # the mean human JND for each distortion for normalization

            step = swirl_jnd_mean/step_num
            data = []
            ...
            for index , path in zip(range(18),paths + upaths):
                ...
                while jnd < 2*step_num:
                    ...
                    sigma = 1.3 * (10 ** (3 * jnd*step))
                    filename512 = pre+"512_"+path+".png"
                    filename2 = pre + "tmp_swirl.png"
            ...
            csv_name = "mono_swirl_" + mode+"_distance.csv"
